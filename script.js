...
function criarBG(){
    //context.fillStyle = "rgba(15, 150, 10, 0.4)";
    //context.fillRect(0, 0, 16*box, 16*box); //desenha o retângulo usando x e y e a largura e altura setadas
    var d = document.getElementById("snake");
    var ctx = d.getContext("2d");
    var img = document.getElementById("grama");
    ctx.drawImage(img, 0, 0);
}

function criarCobrinha (){
    for(i = 0; i < snake.length; i++){
        context.fillStyle = "rgba(153, 76, 0, 0.7)";
...
function drawFood (){
    /*context.fillStyle = "red";//mudar cor por imagem
